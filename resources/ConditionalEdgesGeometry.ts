...
// https://github.com/gkjohnson/threejs-sandbox/blob/master/conditional-lines/src/ConditionalEdgesGeometry.js
...
export class ConditionalEdgesGeometry extends BufferGeometry {
  constructor(geometry: BufferGeometry) {
    ...
    if (geometry.index) {
      ...
      const arr = new Array(position.count / 3).fill(null).map((_, i) => i);
